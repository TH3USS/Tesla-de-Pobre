...
https://seurobo.com.br/robo-autonomosr-1-o-robo-autonomo-simples-com-arduino/
*/
...
//Definindo os pinos  
#define trigPin 2 //Pino TRIG do sensor no pino 2
#define echoPin 13 //Pino ECHO do sensor no pino 13
#define BUZZER 0  // Define o pino do buzzer (Som) no pino 0  
